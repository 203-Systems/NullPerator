...
#ifndef PICOTRACKER_SHARED_TRACE_RECORD_H
#define PICOTRACKER_SHARED_TRACE_RECORD_H
...
enum class TraceName : std::uint16_t {
  ...
  MidiOutput,
  BenchmarkBlock,
  AudioCallbackCount = 20,
  AudioUnderrunFrames = 21,
  AudioOverrunFrames = 22,
  StorageSync = 23,
  InputAccepted = 24,
  InputPresented = 25,
  InputToFrameLatencyUs = 26,
  InputLatencyDropped = 27,
  AudioRenderDurationUs = 28,
  AudioCallbackDurationUs = 29,
  AudioCallbackMaxDurationUs = 30,
...
enum class TraceThread : std::uint8_t {
  Application = 1,
  Browser = 2,
  AudioWorklet = 3
};
...
struct TraceRecord {
  ...
  TraceCategory category = TraceCategory::Ui;
