...
AndroidUiPresenter::AndroidUiPresenter() { pendingDirty_.MarkAll(); }

ui2::PresentResult
AndroidUiPresenter::Present(const ui2::UiIndexedSurface &surface,
...
bool AndroidUiPresenter::DrainFrame(std::uint32_t afterSequence,
