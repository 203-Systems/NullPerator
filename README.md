...
| NullPerator for Android (experimental) | Native C++ core with bundled Svelte controls | AAudio playback and recording, system WAV picker and Files integration, ZIP backup, USB/system MIDI routing |
